...
function Production({ recipes, save }) {
  ...
  }, style: { ...btn, background: bgCard, color: danger, border: `1px solid ${danger}30`, fontSize: 10, padding: "4px 10px" } }, "Delete"))))), savedConfigs.length === 0 && !target && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: textDim, padding: "8px 0" } }, "Set a production quantity above and save it. Your saved setups appear here for quick access.")), recipe && !target && /* @__PURE__ */ React.createElement("div", { style: { ...card } }, /* @__PURE__ */ React.createElement("label", { style: lbl }, "Quick Select Production Size"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 6, marginTop: 4 } }, quickSizes.map((q) => /* @__PURE__ */ React.createElement("button", { key: q.label, onClick: () => {
...
function CostCalc({ recipes, save }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "'Odibee Sans',cursive", color: gold, fontSize: 20, margin: "0 0 4px", letterSpacing: 3, textTransform: "uppercase" } }, "Costs / Profit Calculator"), /* @__PURE__ */ React.createElement("p", { style: { color: textMuted, fontSize: 12, margin: "0 0 12px" } }, "All costs excl. 21% BTW. Enter retail price incl. BTW \u2014 margin is calculated on your revenue excl. BTW."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 12 } }, recipes.map((r) => /* @__PURE__ */ React.createElement("div", { key: r.id, onClick: () => setSelId(String(r.id)), style: { padding: "10px 14px", background: +selId === r.id ? `${gold}15` : bgCard, border: `1px solid ${+selId === r.id ? gold : border}`, borderRadius: 8, cursor: "pointer", transition: "all .15s", flex: "1 1 200px", minWidth: 160 }, onMouseEnter: (e) => {
    ...
    save(recipes.map((r) => r.id === recipe.id ? updated : r));
    setConfigName("");
  }, disabled: !configName.trim(), style: { ...btn, background: gold, color: bg, fontWeight: 600, fontSize: 10, padding: "4px 10px", opacity: configName.trim() ? 1 : 0.4 } }, "+ Save New"))), (recipe.costConfigs || []).length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 4 } }, (recipe.costConfigs || []).map((cfg) => {
    const loadCfg = () => {
