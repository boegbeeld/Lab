...
function rowToScent(r) {
  const raw = (r.ifra_source || "").trim().toLowerCase();
  const status = raw === "verified" ? "verified" : raw === "url_verified" ? "estimated" : raw === "estimated" ? "estimated" : "needs_check";
  return {
    name: r.name,
    type: r.type || "FO",
    family: r.family || "",
...
function rowToBase(r) {
  const raw = (r.verification || "").trim().toLowerCase();
  const hasPrice = parseFloat(r.price_eur) > 0;
  const hasUrl = r.url && r.url.includes("http");
  const status = raw === "verified" ? "verified" : raw === "estimated" ? "estimated" : raw === "needs_check" ? "needs_check" : hasPrice && hasUrl ? "verified" : hasPrice || hasUrl ? "estimated" : "needs_check";
  return {
    name: r.name,
    inci: r.inci || "",
    role: r.role || "carrier",
...
const StatusBadge = ({ status }) => {
  const cfg = status === "verified" ? { c: ok, t: "\u2713 Verified" } : status === "estimated" ? { c: warn, t: "\u26A0 Estimated" } : { c: danger, t: "\u2717 Needs check" };
  return /* @__PURE__ */ React.createElement("span", { style: { fontSize: 9, padding: "1px 6px", borderRadius: 4, background: cfg.c + "20", color: cfg.c, fontWeight: 600 } }, cfg.t);
};
...
function Dashboard({ recipes, setTab }) {
  const verifiedScents = SCENTS.filter((s) => s.status === "verified").length;
  const estimatedScents = SCENTS.filter((s) => s.status === "estimated").length;
  const needsCheckScents = SCENTS.length - verifiedScents - estimatedScents;
  const basesVerified = BASES.filter((b) => b.status === "verified").length;
  const basesEstimated = BASES.filter((b) => b.status === "estimated").length;
  const basesNeedsCheck = BASES.length - basesVerified - basesEstimated;
...
function Library() {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "'Odibee Sans',cursive", color: gold, fontSize: 20, margin: "0 0 4px", letterSpacing: 3, textTransform: "uppercase" } }, "Scent Library ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: textMuted, fontFamily: "'Open Sans'", letterSpacing: 0, textTransform: "none" } }, "(", allScents.length, " scents)")), /* @__PURE__ */ React.createElement("p", { style: { color: textMuted, fontSize: 12, margin: "0 0 12px" } }, "All prices excl. BTW. Click any row to expand IFRA details."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 12, alignItems: "center" } }, /* @__PURE__ */ React.createElement("input", { value: q, onChange: (e) => setQ(e.target.value), placeholder: "Search scent, profile, family...", style: { ...inp, flex: "1 1 180px", minWidth: 150 } }), /* @__PURE__ */ React.createElement("select", { value: tf, onChange: (e) => setTf(e.target.value), style: { ...inp, width: 130 } }, /* @__PURE__ */ React.createElement("option", { value: "all" }, "All Types"), /* @__PURE__ */ React.createElement("option", { value: "EO" }, "Essential Oil"), /* @__PURE__ */ React.createElement("option", { value: "FO" }, "Fragrance Oil"), /* @__PURE__ */ React.createElement("option", { value: "CO2" }, "CO\u2082 Extract")), /* @__PURE__ */ React.createElement("select", { value: ff, onChange: (e) => setFf(e.target.value), style: { ...inp, width: 140 } }, /* @__PURE__ */ React.createElement("option", { value: "all" }, "All Families"), families.map((f) => /* @__PURE__ */ React.createElement("option", { key: f, value: f }, f))), /* @__PURE__ */ React.createElement("select", { value: mf, onChange: (e) => setMf(+e.target.value), style: { ...inp, width: 140 } }, /* @__PURE__ */ React.createElement("option", { value: 0 }, "Any Masculinity"), /* @__PURE__ */ React.createElement("option", { value: 3 }, "3+ Unisex-Masc"), /* @__PURE__ */ React.createElement("option", { value: 4 }, "4+ Masculine"), /* @__PURE__ */ React.createElement("option", { value: 5 }, "5 Very Masculine")), /* @__PURE__ */ React.createElement("select", { value: cv, onChange: (e) => setCv(e.target.value), style: { ...inp, width: 200, background: cv !== "all" ? `${gold}15` : bgInput, borderColor: cv !== "all" ? gold : border } }, /* @__PURE__ */ React.createElement("option", { value: "all" }, "All Categories (no filter)"), IFRA_CAT_ORDER.map((k) => /* @__PURE__ */ React.createElement("option", { key: k, value: k }, "Cat ", k, ": ", IFRA_CATS[k].label))), /* @__PURE__ */ React.createElement("a", { href: SHEETS_CONFIG.editScents, target: "_blank", rel: "noopener noreferrer", style: { ...btn, background: bgInput, color: gold, border: `1px solid ${gold}40`, fontSize: 11, textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 4 } }, "+ Add in Google Sheet")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: textMuted, marginBottom: 8 } }, "Showing ", /* @__PURE__ */ React.createElement("strong", { style: { color: textMain } }, filtered.length), cv !== "all" && /* @__PURE__ */ React.createElement(React.Fragment, null, " \u2014 Max % for ", /* @__PURE__ */ React.createElement("strong", { style: { color: gold } }, "Cat ", cv), " (", IFRA_CATS[cv].label, ")")), /* @__PURE__ */ React.createElement("div", { style: { overflowX: "auto" } }, /* @__PURE__ */ React.createElement("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: 12 } }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", { style: { borderBottom: `1px solid ${border}` } }, ["Name", "Type", "Family", "Note", cv !== "all" ? "IFRA Max %" : "IFRA", "Status", "Masculinity", "Links"].map((h) => /* @__PURE__ */ React.createElement("th", { key: h, style: { padding: "6px 8px", textAlign: "left", color: textDim, fontWeight: 600, fontSize: 10, textTransform: "uppercase", letterSpacing: 1 } }, h)))), /* @__PURE__ */ React.createElement("tbody", null, filtered.map((s, i) => {
    ...
    } }, /* @__PURE__ */ React.createElement("td", { style: { padding: "6px 8px", fontWeight: 600, maxWidth: 200 } }, s.name), /* @__PURE__ */ React.createElement("td", { style: { padding: "6px 8px" } }, /* @__PURE__ */ React.createElement(TypeBadge, { t: s.type })), /* @__PURE__ */ React.createElement("td", { style: { padding: "6px 8px", color: textMuted, fontSize: 11 } }, s.family), /* @__PURE__ */ React.createElement("td", { style: { padding: "6px 8px", color: textMuted, fontSize: 11 } }, s.note), cv !== "all" && /* @__PURE__ */ React.createElement("td", { style: { padding: "6px 8px" } }, /* @__PURE__ */ React.createElement("span", { style: { color: mx === 0 ? danger : mx < 1 ? warn : ok, fontWeight: 600 } }, mx === 0 ? "\u26D4" : "" + mx + "%")), cv === "all" && /* @__PURE__ */ React.createElement("td", { style: { padding: "6px 8px", color: textDim } }, "\u2014"), /* @__PURE__ */ React.createElement("td", { style: { padding: "6px 8px" } }, /* @__PURE__ */ React.createElement(StatusBadge, { status: s.status })), /* @__PURE__ */ React.createElement("td", { style: { padding: "6px 8px" } }, /* @__PURE__ */ React.createElement(Dots, { n: s.masculine })), /* @__PURE__ */ React.createElement("td", { style: { padding: "6px 4px" } }, /* @__PURE__ */ React.createElement("a", { href: url, target: "_blank", rel: "noopener noreferrer", onClick: (e) => e.stopPropagation(), style: { color: gold, fontSize: 10, textDecoration: "none", opacity: 0.7 } }, "\u{1F517}"))), open && /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", { colSpan: 8, style: { padding: "0 8px 8px", background: bgCard } }, /* @__PURE__ */ React.createElement("div", { style: { padding: "10px 14px", borderRadius: 8, background: bgInput, border: `1px solid ${border}` } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: textMain, marginBottom: 8 } }, /* @__PURE__ */ React.createElement("strong", { style: { color: gold } }, "Profile:"), " ", s.profile), s.inci && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: textMuted, marginBottom: 8, fontStyle: "italic" } }, /* @__PURE__ */ React.createElement("strong", { style: { color: gold } }, "INCI:"), " ", s.inci), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 6, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement(StatusBadge, { status: s.status }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: textDim } }, "\u20AC", (s.pricePer100ml || 0).toFixed(2), "/100ml"), /* @__PURE__ */ React.createElement("a", { href: SHEETS_CONFIG.editScents, target: "_blank", rel: "noopener noreferrer", onClick: (e) => e.stopPropagation(), style: { ...btn, fontSize: 10, color: gold, background: "transparent", border: `1px solid ${gold}30`, padding: "2px 8px", textDecoration: "none" } }, "\u{1F4DD} Edit in Sheet")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 6, marginBottom: 8 } }, IFRA_CAT_ORDER.map((cat) => {
...
function Builder({ recipes, save, goRecipes, editingProduct, clearEdit }) {
  ...
  useEffect(() => {
    if (editingProduct) {
      ...
      setInstructions(editingProduct.instructions || []);
      clearEdit();
    }
  }, [editingProduct]);
  ...
  }, onBlur: () => setTimeout(() => setPkgSearch(null), 200), placeholder: "+ Search or click to add packaging items...", style: { ...inp, width: "100%" } }), pkgSearch !== null && /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: "100%", left: 0, right: 0, zIndex: 10, background: bgCard, border: `1px solid ${border}`, borderRadius: 6, maxHeight: 200, overflowY: "auto", marginTop: 2 } }, PACKAGING_ITEMS.filter((p) => !selectedPkg.find((s) => s.name === p.name)).filter((p) => !pkgSearch || p.name.toLowerCase().includes(pkgSearch.toLowerCase()) || p.category.toLowerCase().includes(pkgSearch.toLowerCase()) || p.description.toLowerCase().includes(pkgSearch.toLowerCase())).map((p) => /* @__PURE__ */ React.createElement("div", { key: p.name, onClick: () => {
    setSelectedPkg([...selectedPkg, p]);
    setPkgSearch(null);
  }, style: { padding: "6px 10px", cursor: "pointer", fontSize: 12, borderBottom: `1px solid ${border}20` }, onMouseEnter: (e) => e.currentTarget.style.background = `${gold}15`, onMouseLeave: (e) => e.currentTarget.style.background = "transparent" }, /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 600 } }, p.name), " ", /* @__PURE__ */ React.createElement("span", { style: { color: textMuted, fontSize: 10 } }, "(", p.category, ") \u2014 \u20AC", p.price_eur.toFixed(2), "/", p.per_unit, " excl. BTW"))), PACKAGING_ITEMS.filter((p) => !selectedPkg.find((s) => s.name === p.name)).length === 0 && /* @__PURE__ */ React.createElement("div", { style: { padding: "8px 10px", color: textMuted, fontSize: 11 } }, "No more items. Add packaging in Google Sheet."))), selectedPkg.map((p, i) => /* @__PURE__ */ React.createElement("div", { key: p.name, style: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "4px 0", borderTop: i > 0 ? `1px solid ${border}20` : "none" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 600, fontSize: 12 } }, p.name), " ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: textMuted } }, "(", p.category, ")")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { color: gold, fontSize: 12, fontWeight: 600 } }, "\u20AC", p.price_eur.toFixed(2)), /* @__PURE__ */ React.createElement("button", { onClick: () => setSelectedPkg(selectedPkg.filter((_, j) => j !== i)), style: { background: "none", border: "none", color: danger, cursor: "pointer", fontSize: 14 } }, "\xD7")))), selectedPkg.length === 0 && PACKAGING_ITEMS.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: textMuted, padding: "8px 0" } }, "No packaging items in Google Sheet yet. Add them in the Packaging tab.")), /* @__PURE__ */ React.createElement("div", { style: card }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 600, fontSize: 14 } }, "Step 4 \u2014 Production Instructions"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: instructions.length > 0 ? gold : textMuted } }, instructions.length, " step", instructions.length !== 1 ? "s" : "")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: textMuted, marginBottom: 8 } }, "Add step-by-step instructions for production workers. These become a clickable checklist in the Production tab."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, marginBottom: 8 } }, /* @__PURE__ */ React.createElement("input", { value: newInstruction, onChange: (e) => setNewInstruction(e.target.value), onKeyDown: (e) => {
    if (e.key === "Enter" && newInstruction.trim()) {
      setInstructions([...instructions, newInstruction.trim()]);
      setNewInstruction("");
    }
  }, placeholder: "e.g. Melt beeswax in water bath at 65\xB0C", style: { ...inp, flex: 1 } }), /* @__PURE__ */ React.createElement("button", { onClick: () => {
    if (newInstruction.trim()) {
      setInstructions([...instructions, newInstruction.trim()]);
      setNewInstruction("");
    }
  }, disabled: !newInstruction.trim(), style: { ...btn, background: gold, color: bg, fontWeight: 600, fontSize: 11, padding: "6px 14px", opacity: newInstruction.trim() ? 1 : 0.4 } }, "+ Add")), instructions.map((inst, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", gap: 8, alignItems: "center", padding: "6px 0", borderTop: i > 0 ? `1px solid ${border}20` : "none" } }, /* @__PURE__ */ React.createElement("span", { style: { color: gold, fontWeight: 700, fontSize: 11, flexShrink: 0, width: 22, textAlign: "center" } }, i + 1, "."), /* @__PURE__ */ React.createElement("span", { style: { flex: 1, fontSize: 12 } }, inst), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 2, flexShrink: 0 } }, i > 0 && /* @__PURE__ */ React.createElement("button", { onClick: () => {
    const n = [...instructions];
    [n[i - 1], n[i]] = [n[i], n[i - 1]];
    setInstructions(n);
  }, style: { background: "none", border: "none", color: textMuted, cursor: "pointer", fontSize: 11, padding: "2px" } }, "\u2191"), i < instructions.length - 1 && /* @__PURE__ */ React.createElement("button", { onClick: () => {
    const n = [...instructions];
    [n[i], n[i + 1]] = [n[i + 1], n[i]];
    setInstructions(n);
  }, style: { background: "none", border: "none", color: textMuted, cursor: "pointer", fontSize: 11, padding: "2px" } }, "\u2193"), /* @__PURE__ */ React.createElement("button", { onClick: () => setInstructions(instructions.filter((_, j) => j !== i)), style: { background: "none", border: "none", color: danger, cursor: "pointer", fontSize: 13, padding: "2px 4px" } }, "\xD7"))))), /* @__PURE__ */ React.createElement("div", { style: { ...card, display: "flex", flexWrap: "wrap", gap: 10, alignItems: "end" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: "1 1 200px" } }, /* @__PURE__ */ React.createElement("label", { style: lbl }, "Product Name"), /* @__PURE__ */ React.createElement("input", { value: name, onChange: (e) => setName(e.target.value), placeholder: "e.g. Boegbeeld Signature Pomade v1", style: inp })), /* @__PURE__ */ React.createElement("div", { style: { flex: "1 1 200px" } }, /* @__PURE__ */ React.createElement("label", { style: lbl }, "Notes (optional)"), /* @__PURE__ */ React.createElement("input", { value: notes, onChange: (e) => setNotes(e.target.value), placeholder: "Internal notes...", style: inp })), /* @__PURE__ */ React.createElement("button", { onClick: handleSave, disabled: !name.trim() || hasIFRAWarn, style: { ...btn, background: hasIFRAWarn ? textDim : gold, color: hasIFRAWarn ? textMuted : bg, fontWeight: 600, padding: "8px 24px", cursor: hasIFRAWarn || !name.trim() ? "not-allowed" : "pointer", opacity: !name.trim() ? 0.5 : 1 } }, hasIFRAWarn ? "Fix IFRA Warnings" : editId ? "Update Product" : "Save Product"), saved && /* @__PURE__ */ React.createElement("span", { style: { color: ok, fontSize: 12 } }, "[x] Saved! View in Saved Products tab.")));
}
function Recipes({ recipes, save, goBuilder, onEdit }) {
  ...
  const copyForSheet = (r) => {
    ...
    rows.push("");
    rows.push(["INCI LIST", ...[...(r.bases || []).map((b) => ({ inci: b.inci, pct: b.pct || 0 })), ...(r.scents || []).map((s) => ({ inci: s.inci || "Parfum", pct: s.pct || 0 }))].sort((a, b) => b.pct - a.pct).map((x) => x.inci).filter((v, i, a) => v && a.indexOf(v) === i)].join(", "));
...
----------------------------------------
${[...(r.bases || []).map((b) => ({ inci: b.inci, pct: b.pct || 0 })), ...(r.scents || []).map((s) => ({ inci: s.inci || "Parfum", pct: s.pct || 0 }))].sort((a, b) => b.pct - a.pct).map((x) => x.inci).filter((v, i, a) => v && a.indexOf(v) === i).join(", ")}
...
function Production({ recipes, save }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "'Odibee Sans',cursive", color: gold, fontSize: 20, margin: "0 0 4px", letterSpacing: 3, textTransform: "uppercase" } }, "Production Scale-Up"), /* @__PURE__ */ React.createElement("p", { style: { color: textMuted, fontSize: 12, margin: "0 0 12px" } }, "Select a saved recipe and scale it to any production quantity."), recipes.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "50px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 44, marginBottom: 12 } }, "\u{1F3ED}"), /* @__PURE__ */ React.createElement("h3", { style: { fontFamily: "'Open Sans',sans-serif", color: gold, fontWeight: 700 } }, "No Products to Produce"), /* @__PURE__ */ React.createElement("p", { style: { color: textMuted, fontSize: 13 } }, "Create and save a recipe in the Product Builder first.")), recipes.length > 0 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { ...card, display: "flex", flexWrap: "wrap", gap: 12, alignItems: "end" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: "0 0 auto" } }, /* @__PURE__ */ React.createElement("label", { style: lbl }, "Production Quantity"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4 } }, /* @__PURE__ */ React.createElement("input", { type: "number", value: targetQty, onChange: (e) => setTargetQty(e.target.value), placeholder: "e.g. 5", style: { ...inp, width: 80, textAlign: "center" } }), /* @__PURE__ */ React.createElement("select", { value: targetUnit, onChange: (e) => setTargetUnit(e.target.value), style: { ...inp, width: 60 } }, /* @__PURE__ */ React.createElement("option", { value: "ml" }, "ml"), /* @__PURE__ */ React.createElement("option", { value: "L" }, "L"), /* @__PURE__ */ React.createElement("option", { value: "g" }, "g"), /* @__PURE__ */ React.createElement("option", { value: "kg" }, "kg")))), /* @__PURE__ */ React.createElement("div", { style: { flex: "0 0 auto" } }, /* @__PURE__ */ React.createElement("label", { style: lbl }, "Container Size (optional)"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4 } }, /* @__PURE__ */ React.createElement("input", { type: "number", value: containerSize, onChange: (e) => setContainerSize(e.target.value), placeholder: "e.g. 30", style: { ...inp, width: 70, textAlign: "center" } }), /* @__PURE__ */ React.createElement("select", { value: containerUnit, onChange: (e) => setContainerUnit(e.target.value), style: { ...inp, width: 60 } }, /* @__PURE__ */ React.createElement("option", { value: "ml" }, "ml"), /* @__PURE__ */ React.createElement("option", { value: "g" }, "g")))), recipe && target > 0 && /* @__PURE__ */ React.createElement("div", { style: { flex: "0 0 auto" } }, /* @__PURE__ */ React.createElement("label", { style: lbl }, "Save This Setup"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4 } }, /* @__PURE__ */ React.createElement("input", { value: configName, onChange: (e) => setConfigName(e.target.value), placeholder: "e.g. 200x15ml bottles", style: { ...inp, width: 180, fontSize: 11 } }), /* @__PURE__ */ React.createElement("button", { onClick: saveConfig, disabled: !configName.trim(), style: { ...btn, background: gold, color: bg, fontWeight: 600, fontSize: 10, padding: "4px 10px", opacity: configName.trim() ? 1 : 0.4 } }, "+ Save")))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 12 } }, recipes.map((r) => /* @__PURE__ */ React.createElement("div", { key: r.id, onClick: () => {
    setSelId(String(r.id));
    setChecked({});
  }, style: { padding: "10px 14px", background: +selId === r.id ? `${gold}15` : bgCard, border: `1px solid ${+selId === r.id ? gold : border}`, borderRadius: 8, cursor: "pointer", transition: "all .15s", flex: "1 1 200px", minWidth: 160 }, onMouseEnter: (e) => {
    if (+selId !== r.id) e.currentTarget.style.borderColor = gold + "60";
  }, onMouseLeave: (e) => {
    if (+selId !== r.id) e.currentTarget.style.borderColor = border;
  } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 600, fontSize: 13, color: +selId === r.id ? gold : textMain } }, r.name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: textMuted } }, r.productName, " \xB7 ", r.batchSize, r.batchUnit, " \xB7 ", (r.bases?.length || 0) + (r.scents?.length || 0), " ingredients"), (r.productionConfigs || []).length > 0 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 9, color: gold, marginTop: 2 } }, (r.productionConfigs || []).length, " saved setup", (r.productionConfigs || []).length !== 1 ? "s" : "")))), recipe && savedConfigs.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { ...card, marginTop: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Odibee Sans',cursive", color: gold, fontSize: 14, letterSpacing: 1, marginBottom: 8 } }, "SAVED PRODUCTION SETUPS"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 4 } }, savedConfigs.map((cfg) => /* @__PURE__ */ React.createElement("div", { key: cfg.id, style: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 12px", background: bgInput, borderRadius: 8, border: `1px solid ${border}` } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, cursor: "pointer" }, onClick: () => loadConfig(cfg) }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 600, fontSize: 12, color: gold } }, cfg.name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: textMuted } }, cfg.targetQty, " ", cfg.targetUnit, cfg.containerSize ? ` \xB7 ${cfg.containerSize}${cfg.containerUnit} containers` : "", " \xB7 saved ", new Date(cfg.savedAt).toLocaleDateString("nl-NL"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, alignItems: "center", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => loadConfig(cfg), style: { ...btn, background: `${gold}15`, color: gold, border: `1px solid ${gold}30`, fontSize: 10, padding: "4px 10px" } }, "Load"), /* @__PURE__ */ React.createElement("button", { onClick: () => {
    loadConfig(cfg);
    setConfigName(cfg.name);
    delConfig(cfg.id);
  }, style: { ...btn, background: bgCard, color: textMuted, border: `1px solid ${border}`, fontSize: 10, padding: "4px 10px" } }, "Edit"), /* @__PURE__ */ React.createElement("button", { onClick: () => {
    if (confirm(`Delete "${cfg.name}"?`)) delConfig(cfg.id);
  }, style: { ...btn, background: bgCard, color: danger, border: `1px solid ${danger}30`, fontSize: 10, padding: "4px 10px" } }, "Delete")))))), recipe && !target && /* @__PURE__ */ React.createElement("div", { style: { ...card } }, /* @__PURE__ */ React.createElement("label", { style: lbl }, "Quick Select Production Size"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 6, marginTop: 4 } }, quickSizes.map((q) => /* @__PURE__ */ React.createElement("button", { key: q.label, onClick: () => {
  ...
  }))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: textMuted, marginTop: 6, paddingTop: 6, borderTop: `1px solid ${border}30` } }, "Total fragrance: ", /* @__PURE__ */ React.createElement("strong", { style: { color: gold } }, (recipe.totalScentPct / 100 * targetInOrigUnit).toFixed(2), " ", origUnit), " (", recipe.totalScentPct, "%)")), /* @__PURE__ */ React.createElement("div", { style: { ...card, background: bgInput, border: `1px solid ${gold}30` } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Odibee Sans',cursive", color: gold, fontSize: 15, marginBottom: 8 } }, "Production Summary"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: 12, fontSize: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { padding: "10px 14px", background: bgCard, borderRadius: 8, border: `1px solid ${border}` } }, /* @__PURE__ */ React.createElement("div", { style: { color: textMuted, fontSize: 10, textTransform: "uppercase", marginBottom: 2 } }, "Total Production"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Odibee Sans',cursive", color: gold, fontSize: 20 } }, target, " ", targetUnit)), /* @__PURE__ */ React.createElement("div", { style: { padding: "10px 14px", background: bgCard, borderRadius: 8, border: `1px solid ${border}` } }, /* @__PURE__ */ React.createElement("div", { style: { color: textMuted, fontSize: 10, textTransform: "uppercase", marginBottom: 2 } }, "Scale Factor"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Odibee Sans',cursive", color: gold, fontSize: 20 } }, scaleFactor.toFixed(1), "\xD7"), /* @__PURE__ */ React.createElement("div", { style: { color: textDim, fontSize: 10 } }, "from ", origSize, origUnit, " recipe")), numContainers > 0 && /* @__PURE__ */ React.createElement("div", { style: { padding: "10px 14px", background: bgCard, borderRadius: 8, border: `1px solid ${border}` } }, /* @__PURE__ */ React.createElement("div", { style: { color: textMuted, fontSize: 10, textTransform: "uppercase", marginBottom: 2 } }, "Containers"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Odibee Sans',cursive", color: gold, fontSize: 20 } }, "~", numContainers, " pcs"), /* @__PURE__ */ React.createElement("div", { style: { color: textDim, fontSize: 10 } }, "@ ", containerSize, containerUnit, " each")), /* @__PURE__ */ React.createElement("div", { style: { padding: "10px 14px", background: bgCard, borderRadius: 8, border: `1px solid ${border}` } }, /* @__PURE__ */ React.createElement("div", { style: { color: textMuted, fontSize: 10, textTransform: "uppercase", marginBottom: 2 } }, "Ingredients Count"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Odibee Sans',cursive", color: gold, fontSize: 20 } }, (recipe.bases?.length || 0) + (recipe.scents?.length || 0)), /* @__PURE__ */ React.createElement("div", { style: { color: textDim, fontSize: 10 } }, recipe.bases?.length || 0, " base + ", recipe.scents?.length || 0, " scent"))), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12, paddingTop: 12, borderTop: `1px solid ${border}30`, display: "grid", gridTemplateColumns: recipe.instructions?.length > 0 ? "1fr 1fr" : "1fr", gap: 16 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: textMuted, fontWeight: 600, textTransform: "uppercase", letterSpacing: 1, marginBottom: 6 } }, "Weigh-Out Checklist"), recipe.bases?.map((b, i) => {
    const scaled = b.pct / 100 * targetInOrigUnit;
    const disp = scaled >= 1e3 ? `${(scaled / 1e3).toFixed(2)} ${origUnit === "g" ? "kg" : "L"}` : `${scaled.toFixed(2)} ${origUnit}`;
    const id = `wb-${i}`;
    const done = checked[id];
    return /* @__PURE__ */ React.createElement("div", { key: i, onClick: () => toggleCheck(id), style: { display: "flex", gap: 8, alignItems: "center", padding: "6px 4px", fontSize: 12, cursor: "pointer", borderTop: i > 0 ? `1px solid ${border}15` : "none", background: done ? `${ok}08` : "transparent", borderRadius: 4, transition: "all .15s", opacity: done ? 0.6 : 1 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 18, height: 18, borderRadius: 4, border: `2px solid ${done ? ok : border}`, background: done ? ok : "transparent", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, transition: "all .15s" } }, done && /* @__PURE__ */ React.createElement("span", { style: { color: "#fff", fontSize: 12, fontWeight: 700 } }, "\u2713")), /* @__PURE__ */ React.createElement("span", { style: { color: textMain, fontWeight: 500, flex: 1, textDecoration: done ? "line-through" : "none" } }, b.name), /* @__PURE__ */ React.createElement("span", { style: { color: gold, fontWeight: 700, flexShrink: 0 } }, disp));
  }), recipe.scents?.map((s, i) => {
    const scaledMl = s.pct / 100 * targetInOrigUnit;
    const id = `ws-${i}`;
    const done = checked[id];
    return /* @__PURE__ */ React.createElement("div", { key: `s${i}`, onClick: () => toggleCheck(id), style: { display: "flex", gap: 8, alignItems: "center", padding: "6px 4px", fontSize: 12, cursor: "pointer", borderTop: `1px solid ${border}15`, background: done ? `${ok}08` : "transparent", borderRadius: 4, transition: "all .15s", opacity: done ? 0.6 : 1 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 18, height: 18, borderRadius: 4, border: `2px solid ${done ? ok : border}`, background: done ? ok : "transparent", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, transition: "all .15s" } }, done && /* @__PURE__ */ React.createElement("span", { style: { color: "#fff", fontSize: 12, fontWeight: 700 } }, "\u2713")), /* @__PURE__ */ React.createElement("span", { style: { color: textMain, fontWeight: 500, flex: 1, textDecoration: done ? "line-through" : "none" } }, s.name, " ", /* @__PURE__ */ React.createElement(TypeBadge, { t: s.type })), /* @__PURE__ */ React.createElement("span", { style: { color: gold, fontWeight: 700, flexShrink: 0 } }, scaledMl.toFixed(2), " ml"));
  }), (() => {
    const total = (recipe.bases?.length || 0) + (recipe.scents?.length || 0);
    const checkedCount = Object.values(checked).filter(Boolean).length;
    const weighChecked = Object.entries(checked).filter(([k, v]) => v && (k.startsWith("wb-") || k.startsWith("ws-"))).length;
    return total > 0 && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8, fontSize: 11, color: weighChecked === total ? ok : textMuted, fontWeight: 600 } }, weighChecked, " / ", total, " weighed", weighChecked === total ? " \u2014 All done! \u2713" : "");
  })()), recipe.instructions?.length > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: textMuted, fontWeight: 600, textTransform: "uppercase", letterSpacing: 1, marginBottom: 6 } }, "Production Steps"), recipe.instructions.map((inst, i) => {
    const id = `pi-${i}`;
    const done = checked[id];
    return /* @__PURE__ */ React.createElement("div", { key: i, onClick: () => toggleCheck(id), style: { display: "flex", gap: 8, alignItems: "start", padding: "6px 4px", fontSize: 12, cursor: "pointer", borderTop: i > 0 ? `1px solid ${border}15` : "none", background: done ? `${ok}08` : "transparent", borderRadius: 4, transition: "all .15s", opacity: done ? 0.6 : 1 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 18, height: 18, borderRadius: 4, border: `2px solid ${done ? ok : border}`, background: done ? ok : "transparent", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, transition: "all .15s", marginTop: 1 } }, done && /* @__PURE__ */ React.createElement("span", { style: { color: "#fff", fontSize: 12, fontWeight: 700 } }, "\u2713")), /* @__PURE__ */ React.createElement("span", { style: { color: gold, fontWeight: 700, flexShrink: 0, width: 22 } }, i + 1, "."), /* @__PURE__ */ React.createElement("span", { style: { color: textMain, flex: 1, textDecoration: done ? "line-through" : "none" } }, inst));
  }), (() => {
    const total = recipe.instructions.length;
    const stepsDone = Object.entries(checked).filter(([k, v]) => v && k.startsWith("pi-")).length;
    return /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8, fontSize: 11, color: stepsDone === total ? ok : textMuted, fontWeight: 600 } }, stepsDone, " / ", total, " completed", stepsDone === total ? " \u2014 All done! \u2713" : "");
...
function CostCalc({ recipes, save }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "'Odibee Sans',cursive", color: gold, fontSize: 20, margin: "0 0 4px", letterSpacing: 3, textTransform: "uppercase" } }, "Costs / Profit Calculator"), /* @__PURE__ */ React.createElement("p", { style: { color: textMuted, fontSize: 12, margin: "0 0 12px" } }, "All costs excl. 21% BTW. Enter retail price incl. BTW \u2014 margin is calculated on your revenue excl. BTW."), /* @__PURE__ */ React.createElement("div", { style: { ...card, display: "flex", flexWrap: "wrap", gap: 12, alignItems: "end" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: "0 0 auto" } }, /* @__PURE__ */ React.createElement("label", { style: lbl }, "Container Size"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4 } }, /* @__PURE__ */ React.createElement("input", { type: "number", value: containerSz, onChange: (e) => setContainerSz(e.target.value), style: { ...inp, width: 65, textAlign: "center" } }), /* @__PURE__ */ React.createElement("select", { value: containerUnit, onChange: (e) => setContainerUnit(e.target.value), style: { ...inp, width: 50 } }, /* @__PURE__ */ React.createElement("option", { value: "ml" }, "ml"), /* @__PURE__ */ React.createElement("option", { value: "g" }, "g")))), /* @__PURE__ */ React.createElement("div", { style: { flex: "0 0 auto" } }, /* @__PURE__ */ React.createElement("label", { style: lbl }, "Retail Price incl. BTW (\u20AC)"), /* @__PURE__ */ React.createElement("input", { type: "number", step: "0.01", value: retailPrice, onChange: (e) => setRetailPrice(e.target.value), placeholder: "e.g. 14.95", style: { ...inp, width: 90, textAlign: "center" } })), recipe && rp > 0 && cSz > 0 && /* @__PURE__ */ React.createElement("div", { style: { flex: "0 0 auto" } }, /* @__PURE__ */ React.createElement("label", { style: lbl }, "Save This Setup"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4 } }, /* @__PURE__ */ React.createElement("input", { value: configName, onChange: (e) => setConfigName(e.target.value), placeholder: "e.g. 100g jar @ \u20AC24.95", style: { ...inp, width: 180, fontSize: 11 } }), /* @__PURE__ */ React.createElement("button", { onClick: () => {
    if (!configName.trim() || !recipe) return;
    ...
    save(recipes.map((r) => r.id === recipe.id ? updated : r));
    setConfigName("");
  }, disabled: !configName.trim(), style: { ...btn, background: gold, color: bg, fontWeight: 600, fontSize: 10, padding: "4px 10px", opacity: configName.trim() ? 1 : 0.4 } }, "+ Save")))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 12 } }, recipes.map((r) => /* @__PURE__ */ React.createElement("div", { key: r.id, onClick: () => setSelId(String(r.id)), style: { padding: "10px 14px", background: +selId === r.id ? `${gold}15` : bgCard, border: `1px solid ${+selId === r.id ? gold : border}`, borderRadius: 8, cursor: "pointer", transition: "all .15s", flex: "1 1 200px", minWidth: 160 }, onMouseEnter: (e) => {
    if (+selId !== r.id) e.currentTarget.style.borderColor = gold + "60";
  }, onMouseLeave: (e) => {
    if (+selId !== r.id) e.currentTarget.style.borderColor = border;
  } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 600, fontSize: 13, color: +selId === r.id ? gold : textMain } }, r.name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: textMuted } }, r.productName, " \xB7 ", r.batchSize, r.batchUnit), (r.costConfigs || []).length > 0 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 9, color: gold, marginTop: 2 } }, (r.costConfigs || []).length, " saved setup", (r.costConfigs || []).length !== 1 ? "s" : "")))), !recipe && recipes.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { ...card, background: bgInput, border: `1px solid ${gold}20`, textAlign: "center", padding: "20px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: textMuted } }, "\u{1F446} Select a product above to see the full cost breakdown and margin calculation.")), !recipe && recipes.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "30px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 36, marginBottom: 8 } }, "\u{1F4B0}"), /* @__PURE__ */ React.createElement("div", { style: { color: gold, fontWeight: 700, fontSize: 14 } }, "No Products Yet"), /* @__PURE__ */ React.createElement("div", { style: { color: textMuted, fontSize: 12, marginTop: 4 } }, "Create a product in the Product Builder first.")), recipe && (recipe.costConfigs || []).length > 0 && /* @__PURE__ */ React.createElement("div", { style: { ...card, marginTop: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Odibee Sans',cursive", color: gold, fontSize: 14, letterSpacing: 1, marginBottom: 8 } }, "SAVED PRICING SETUPS"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 4 } }, (recipe.costConfigs || []).map((cfg) => {
    const loadCfg = () => {
