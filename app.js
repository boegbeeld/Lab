...
function Production({ recipes, save }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "'Odibee Sans',cursive", color: gold, fontSize: 20, margin: "0 0 4px", letterSpacing: 3, textTransform: "uppercase" } }, "Production Scale-Up"), /* @__PURE__ */ React.createElement("p", { style: { color: textMuted, fontSize: 12, margin: "0 0 12px" } }, "Select a saved recipe and scale it to any production quantity."), recipes.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "50px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 44, marginBottom: 12 } }, "\u{1F3ED}"), /* @__PURE__ */ React.createElement("h3", { style: { fontFamily: "'Open Sans',sans-serif", color: gold, fontWeight: 700 } }, "No Products to Produce"), /* @__PURE__ */ React.createElement("p", { style: { color: textMuted, fontSize: 13 } }, "Create and save a recipe in the Product Builder first.")), recipes.length > 0 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { ...card, display: "flex", flexWrap: "wrap", gap: 12, alignItems: "end" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: "1 1 250px" } }, /* @__PURE__ */ React.createElement("label", { style: lbl }, "Select Product"), /* @__PURE__ */ React.createElement("select", { value: selId, onChange: (e) => setSelId(e.target.value), style: inp }, /* @__PURE__ */ React.createElement("option", { value: "" }, "Choose a product..."), recipes.map((r) => /* @__PURE__ */ React.createElement("option", { key: r.id, value: r.id }, r.name, " (", r.productName, " \xB7 ", r.batchSize, r.batchUnit, " original)")))), recipe && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { flex: "0 0 auto" } }, /* @__PURE__ */ React.createElement("label", { style: lbl }, "Production Quantity"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4 } }, /* @__PURE__ */ React.createElement("input", { type: "number", value: targetQty, onChange: (e) => setTargetQty(e.target.value), placeholder: "e.g. 5", style: { ...inp, width: 80, textAlign: "center" } }), /* @__PURE__ */ React.createElement("select", { value: targetUnit, onChange: (e) => setTargetUnit(e.target.value), style: { ...inp, width: 60 } }, /* @__PURE__ */ React.createElement("option", { value: "ml" }, "ml"), /* @__PURE__ */ React.createElement("option", { value: "L" }, "L"), /* @__PURE__ */ React.createElement("option", { value: "g" }, "g"), /* @__PURE__ */ React.createElement("option", { value: "kg" }, "kg")))), /* @__PURE__ */ React.createElement("div", { style: { flex: "0 0 auto" } }, /* @__PURE__ */ React.createElement("label", { style: lbl }, "Container Size (optional)"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4 } }, /* @__PURE__ */ React.createElement("input", { type: "number", value: containerSize, onChange: (e) => setContainerSize(e.target.value), placeholder: "e.g. 30", style: { ...inp, width: 70, textAlign: "center" } }), /* @__PURE__ */ React.createElement("select", { value: containerUnit, onChange: (e) => setContainerUnit(e.target.value), style: { ...inp, width: 60 } }, /* @__PURE__ */ React.createElement("option", { value: "ml" }, "ml"), /* @__PURE__ */ React.createElement("option", { value: "g" }, "g")))))), recipe && /* @__PURE__ */ React.createElement("div", { style: { ...card, marginTop: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Odibee Sans',cursive", color: gold, fontSize: 14, letterSpacing: 1 } }, "SAVED PRODUCTION SETUPS"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: textMuted } }, "Saved with your product for quick access")), target > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, alignItems: "center" } }, /* @__PURE__ */ React.createElement("input", { value: configName, onChange: (e) => setConfigName(e.target.value), placeholder: "e.g. 200x15ml bottles", style: { ...inp, width: 180, fontSize: 11 } }), /* @__PURE__ */ React.createElement("button", { onClick: saveConfig, disabled: !configName.trim(), style: { ...btn, background: gold, color: bg, fontWeight: 600, fontSize: 10, padding: "4px 10px", opacity: configName.trim() ? 1 : 0.4 } }, "+ Save New"))), savedConfigs.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 4 } }, savedConfigs.map((cfg) => /* @__PURE__ */ React.createElement("div", { key: cfg.id, style: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 12px", background: bgInput, borderRadius: 8, border: `1px solid ${border}` } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 600, fontSize: 12, color: gold } }, cfg.name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: textMuted } }, cfg.targetQty, " ", cfg.targetUnit, cfg.containerSize ? ` \xB7 ${cfg.containerSize}${cfg.containerUnit} containers` : "", " \xB7 saved ", new Date(cfg.savedAt).toLocaleDateString("nl-NL"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, alignItems: "center", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => loadConfig(cfg), style: { ...btn, background: `${gold}15`, color: gold, border: `1px solid ${gold}30`, fontSize: 10, padding: "4px 10px" } }, "Load"), /* @__PURE__ */ React.createElement("button", { onClick: () => {
    ...
    const chkId = `wb-${i}`;
    return /* @__PURE__ */ React.createElement("label", { key: i, htmlFor: chkId, style: { display: "flex", gap: 8, alignItems: "center", padding: "5px 0", fontSize: 12, cursor: "pointer", borderTop: i > 0 ? `1px solid ${border}15` : "none" } }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", id: chkId, style: { width: 16, height: 16, accentColor: gold, flexShrink: 0, cursor: "pointer" } }), /* @__PURE__ */ React.createElement("span", { style: { color: textMain, fontWeight: 500, flex: 1 } }, b.name), /* @__PURE__ */ React.createElement("span", { style: { color: gold, fontWeight: 700, flexShrink: 0 } }, disp));
  }), recipe.scents?.map((s, i) => {
    const scaledMl = s.pct / 100 * targetInOrigUnit;
    const chkId = `ws-${i}`;
    return /* @__PURE__ */ React.createElement("label", { key: `s${i}`, htmlFor: chkId, style: { display: "flex", gap: 8, alignItems: "center", padding: "5px 0", fontSize: 12, cursor: "pointer", borderTop: `1px solid ${border}15` } }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", id: chkId, style: { width: 16, height: 16, accentColor: gold, flexShrink: 0, cursor: "pointer" } }), /* @__PURE__ */ React.createElement("span", { style: { color: textMain, fontWeight: 500, flex: 1 } }, s.name, " ", /* @__PURE__ */ React.createElement(TypeBadge, { t: s.type })), /* @__PURE__ */ React.createElement("span", { style: { color: gold, fontWeight: 700, flexShrink: 0 } }, scaledMl.toFixed(2), " ml"));
    ...
    const chkId = `pi-${i}`;
    return /* @__PURE__ */ React.createElement("label", { key: i, htmlFor: chkId, style: { display: "flex", gap: 8, alignItems: "start", padding: "5px 0", fontSize: 12, cursor: "pointer", borderTop: i > 0 ? `1px solid ${border}15` : "none" } }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", id: chkId, style: { width: 16, height: 16, accentColor: gold, flexShrink: 0, cursor: "pointer", marginTop: 1 } }), /* @__PURE__ */ React.createElement("span", { style: { color: gold, fontWeight: 700, flexShrink: 0, width: 22 } }, i + 1, "."), /* @__PURE__ */ React.createElement("span", { style: { color: textMain, flex: 1 } }, inst));
